    ...
    public serviçoRealizado() {
        ...
        btnConcluir.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ChamadosAceitos ch = new ChamadosAceitos();
                String patrimonio = ch.patrimonio;
                String txtAcao = textAreaServiço.getText();
                ...
                try {
                    ...
                    String sql = "UPDATE chamados\n"
                            ...
                            + "    desc_acao = 'ola' \n"
                            + "WHERE patri_equipamento = 32133213";
                    System.out.println(sql);
                    banco.stmt = banco.con.createStatement();;

                    int resultado = banco.stmt.executeUpdate(
                            "UPDATE chamados SET estatus = 'concluido', desc_acao = '" + txtAcao + "'  WHERE patri_equipamento = '" + patrimonio + "'"
                    );

                    if (resultado > 0) {
                        dispose();
                        JOptionPane.showMessageDialog(null, "Chamado concluido com sucesso!");
                        ChamadosAceitos ca = new ChamadosAceitos();
                        ca.abrirTela();
                        
                    } else {
                        JOptionPane.showMessageDialog(null, "Erro ao concluido o chamado.");
                    }
                } catch (Exception ex) {
                    JOptionPane.showMessageDialog(null, "Erro ao concluido chamado: " + ex.getMessage());
                } finally {
                    banco.FecharConexao();
                }
